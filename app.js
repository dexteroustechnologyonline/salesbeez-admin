...
const pinActivation = require("./routes/pinActivationRoute");
app.use("/api/v1/pinactivation", pinActivation);

const store = require("./routes/storeRoute");
app.use("/api/v1/store", store);

const bussinessHistory = require("./routes/bussinessHistoryRoute");
app.use("/api/v1/bussinesshiostory", bussinessHistory);

const orderProccess = require("./routes/orderProccessRoute");
app.use("/api/v1/orderproccess", orderProccess);

const kit = require("./routes/kitRoute");
app.use("/api/v1/kit", kit);
